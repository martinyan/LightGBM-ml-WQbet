#!/usr/bin/env node
// Create a copy of a JSONL dataset with jockey rolling-365d stats zeroed out (trainer stats kept).
//
// Usage:
//   node hkjc_dataset_zero_jockey_rates_only.mjs --in hkjc_dataset_v2_code_prev1.jsonl --out hkjc_dataset_v2_no_jockey_rates.jsonl
...
console.log(JSON.stringify({out: outPath, rows: out.length},null,2));
