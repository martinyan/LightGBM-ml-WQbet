#!/usr/bin/env python3
"""Append one QIN odds snapshot (single race) into a JSONL file.

This is designed to be triggered by cron many times.
"""
...
def main():
    ...
    cmd = [
        'python3', os.path.join(os.path.dirname(__file__), 'qoddchange_fetch_qin_odds.py'),
        '--date', args.date,
        '--venue', args.venue,
