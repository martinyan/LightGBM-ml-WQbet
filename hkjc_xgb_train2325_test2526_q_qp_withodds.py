...
UA = 'openclaw-hkjc-xgb-train-test/withodds-1.0'
...
def main():
    ...
    ap.add_argument('--out', default='hkjc_xgb_withodds_train2325_test2526_q_qp.json')
    args = ap.parse_args()
    ...
    def vec(r):
        # WITH-ODDS: do not override cur_win_odds
        out = []
        for k in feat_keys:
